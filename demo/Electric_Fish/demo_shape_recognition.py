...
B6 = ImgShape('Test_images/Face.png', N)
...
cnd = 10*np.array([1,1,1,1, 0.5,1])
pmtt = 5*np.array([1,1,1,1, 0.5,1])
...
index_maj, _ = ShapeRecognition_CGPT_majority_voting_frequency(I1, I2, I1_new, I2_new)
